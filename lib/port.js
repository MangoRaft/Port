...
Port.prototype.start = function(options, callback) {
	...
	var _options = {
		...
		config : {
			...
			"Memory" : options.size.memory * 1048576 || 256 * 1048576,
			"MemorySwap" : options.size.memory * 1048576 || 256 * 1048576,
			"MemoryReservation" : options.size.memoryReservation * 1048576 || 256 * 1048576,
			...
			"IOMaximumBandwidth" : options.size.ioMaximumBandwidth * 1048576 || 900 * 1048576,
...
Port.prototype._start = function(options, callback) {
	...
	container.once('STOPPED', function(data) {
		...
		self.removeResources(container.config.Memory / 1048576, container.config.CpusetCpus, container.config.CpuShares);
