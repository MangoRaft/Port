...
class Container extends events.EventEmitter {
    constructor(options) {
        ...
        this.dstats = new DStats(options.stats)
    ...
    stats() {
        ...
        this.dstats.on('aggregated', function (stats) {
        ...
        this.container.stats({
            ...
            rl.on('line', function (line) {
                ...
                json.cpu_stats.quota = self.resource.quota;
                json.cpu_stats.period = self.resource.period;
                self.dstats.stats(json);
            });
        });
    }
