...
var Container = function(options) {
	...
	this.dockerHost = options.node ? options.node.address : options.docker.modem.socketPath ? '127.0.0.1' : options.docker.modem.host;
			...
			self._start(function(err) {
				...
				setTimeout(function() {
					if (self.state == 'CRASHED')
						return callback(new Error('Aplication crashed within 1500ms of starting'));
